...
namespace defarge
{
    ...
    public partial class ServerNodeType : BaseObject
    {
        ...
        protected override void Initialize()
        {
            ...
            auditTableName = "history.core_server_node_type";
    ...
    public partial class ServerNodeTypeHistory : ServerNodeType
    {
        protected override void Initialize()
        {
            ...
            tableName = "history.core_server_node_type";
            tableBaseName = "core_server_node_type";
          

            // Add the foreign key to the original object
            rwk.Add("server_node_type_id");
        ...
        public long server_node_type_id
        {
            get
            {
                long _server_node_type_id = default(long);
