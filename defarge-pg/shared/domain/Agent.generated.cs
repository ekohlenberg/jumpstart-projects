...
namespace defarge
{
    ...
    {
        public Agent(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        protected override void Initialize()
        {
            // Default initializer
            domainName = "Agent";
            tableName = "core.agent";
            schemaName = "core";
            tableBaseName = "agent";
            auditTableName = "history.core_agent";
            ...
            [ColumnInfo("Status", "AgentStatus", "enum", "agent_status", "agentstatus")]
            public long agent_status_id
            {
                get
                {
                    long _agent_status_id;
    ...
    public partial class AgentHistory : Agent
    {
        protected override void Initialize()
        {
            ...
            domainName = "AgentHistory";
            tableName = "history.core_agent";
            tableBaseName = "core_agent";
    ...
    public class AgentView : Agent
    {

            [ColumnInfo("Status", "", "", "", "")]
            public string agent_status_name
            {
                get
                {
                    string _agent_status_name;

                            _agent_status_name = string.Empty;
                                                
                    try
                    {
                        if(this.ContainsKey("agent_status_name"))
                        {
                        _agent_status_name = Convert.ToString(this["agent_status_name"].ToString());
                        }
                    }
                    catch(Exception )
                    {
                        //Logger.Error($"Error getting agent_status_name: {e.Message}");
                        _agent_status_name = default(string);
                    }
                    return _agent_status_name;
                }
                set
                {
                   
                    this["agent_status_name"] = value;
                }
            }
                }
}
