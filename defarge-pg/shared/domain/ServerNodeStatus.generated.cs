...
namespace defarge
{
    ...
    public partial class ServerNodeStatus : BaseObject
    {
        ...
        protected override void Initialize()
        {
            ...
            auditTableName = "history.core_server_node_status";
    ...
    public partial class ServerNodeStatusHistory : ServerNodeStatus
    {
        protected override void Initialize()
        {
            ...
            tableName = "history.core_server_node_status";
            tableBaseName = "core_server_node_status";
          

            // Add the foreign key to the original object
            rwk.Add("server_node_status_id");
        ...
        public long server_node_status_id
        {
            get
            {
                long _server_node_status_id = default(long);
