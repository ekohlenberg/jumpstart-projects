...
psql --host=localhost --port=5433 --dbname=postgres --username=postgres --file=.\defarge.database.create.generated.sql
            ...
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\Principal.table.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\Principal.audit.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\Principal.sequence.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\Principal.rwkindex.generated.sql
            ...
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\Sql.table.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\Sql.audit.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\Sql.sequence.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\Sql.rwkindex.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\NavMenu.table.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\NavMenu.audit.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\NavMenu.sequence.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\NavMenu.rwkindex.generated.sql
            ...
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\PrincipalOrg.table.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\PrincipalOrg.audit.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\PrincipalOrg.sequence.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\PrincipalOrg.rwkindex.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\PrincipalPassword.table.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\PrincipalPassword.audit.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\PrincipalPassword.sequence.generated.sql
        
            psql --host=localhost --port=5433 --dbname=defarge --username=postgres --file=.\PrincipalPassword.rwkindex.generated.sql
