#!/bin/bash
# PostgreSQL Data Load Script Wrapper
# This script calls the Python load script for robust JSON parsing

# Get the directory where this script is located
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PYTHON_SCRIPT="$SCRIPT_DIR/load.py"
...
if [ ! -f "$PYTHON_SCRIPT" ]; then
    echo "Error: Python load script not found at: $PYTHON_SCRIPT" >&2
    exit 1
fi
...
echo "PostgreSQL Data Load Script"
echo "==========================="
echo ""
