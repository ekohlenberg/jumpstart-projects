...
namespace defarge
{
    [ClassInfo("Scheduler Status")]
    public partial class SchedulerStatus : BaseObject
    {
        public SchedulerStatus(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        {
            // Default initializer
            domainName = "SchedulerStatus";
            tableName = "core.scheduler_status";
            schemaName = "core";
            tableBaseName = "scheduler_status";
            auditTableName = "history.core_scheduler_status";
            ...
            [ColumnInfo("Scheduler Status ID", "", "", "", "")]
            public long id
            {
                get
                {
    ...
    public partial class SchedulerStatusHistory : SchedulerStatus
    {
        protected override void Initialize()
        {
            ...
            domainName = "SchedulerStatusHistory";
            tableName = "history.core_scheduler_status";
            tableBaseName = "core_scheduler_status";
          

            // Add the foreign key to the original object
            rwk.Add("scheduler_status_id");
        ...
        public long scheduler_status_id
        {
            get
            {
                long _scheduler_status_id = default(long);
    ...
    public class SchedulerStatusView : SchedulerStatus
    {
    }
}
